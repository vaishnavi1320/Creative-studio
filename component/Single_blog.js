               ...
               <div className="comment-form">
                  ...
                  <form className="form-contact comment_form" action="#" id="commentForm">
                     ...
                     <div className="form-group mt-3">
                        <button type="submit" className="button-contactForm btn_2">Send Message</button>
                     </div>
                  </form>
               </div>
            </div>
               ...
               <div className="blog_right_sidebar">
                  <aside className="single_sidebar_widget search_widget">
                     <form action="#">
                        ...
                        <button className="button rounded-0 primary-bg text-white w-100 btn_2" type="submit">Search</button>
                     </form>
                  </aside>
                     ...
                     <div className="form-wrap" id="mc_embed_signup">
                        <form target="_blank"
                           ...
                           <input className="form-control" name="EMAIL" placeholder="Your Email Address"
                              ...
                              required="" type="email"/>
                           <button className="btn_2 btn-default text-uppercase">SUBSCRIBE</button>
